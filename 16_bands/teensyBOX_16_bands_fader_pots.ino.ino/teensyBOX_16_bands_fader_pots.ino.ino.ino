...
{
  max_brightnessR = map(analogRead(A0), 0, 1023, 0, 255);
  max_brightnessG = map(analogRead(A1), 0, 1023, 0, 255);
  max_brightnessB = map(analogRead(A2), 0, 1023, 0, 255);

  fadeoutR = 20; //map(analogRead(A0), 0, 1023, 0, 50);
  fadeoutG = 20; //map(analogRead(A1), 0, 1023, 0, 50);
  fadeoutB = 20; //map(analogRead(A2), 0, 1023, 0, 50);
